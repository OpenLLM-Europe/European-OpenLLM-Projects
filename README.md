...
| **Lapa LLM** (Ukrainian Catholic University, AGH Kraków, Igor Sikorsky KPI, Lviv Polytechnic) | :ukraine: Ukraine / :poland: Poland | Ukrainian-first multimodal LLM continued from Gemma 3 12B, with open pretraining and instruction datasets | Gemma Terms of Use | lapa-v0.1.3-instruct: 06/2026 | [HF](https://huggingface.co/lapa-llm), [GitHub](https://github.com/lapa-llm) |
| **Latxa** (HiTZ, University of the Basque Country) | :es: Spain | Basque LLMs continued from Llama 3.1, with Basque instruction and evaluation data | Llama 3.1 | 8B Instruct: 08/2026, 70B Instruct v2: 07/2026 | [Latxa Instruct collection](https://huggingface.co/collections/HiTZ/latxa-instruct), [Paper](https://aclanthology.org/2025.emnlp-main.1484/), [Chat demo](https://latxa.hitz.eus/) |
...
| **ELOQUENCE** (Horizon Europe, coordinated by Telefónica Innovación Digital) | Multilingual, bias-controlled dialogue systems for safety-critical uses, 16 partners across 10 countries, 2024-2026 | [eloquenceai.eu](https://eloquenceai.eu/), [CORDIS](https://cordis.europa.eu/project/id/101135916), [GitHub](https://github.com/ELOQUENCEAI), [Zenodo](https://zenodo.org/communities/eloquenceai/) |
